...
class TeamsTable extends Table
{
    ...
    public function teamLists($seasonId, $vsTeam)
    {
        $teams = $this->find('all')
            ...
            ->select(['steal' => '(SELECT sum(players.steal) FROM players WHERE players.team_id = Teams.id)'])
            ->select(['sansin' => '(SELECT sum(players.sansin) FROM players WHERE players.team_id = Teams.id)'])
            ->select(['get_sansin' => '(SELECT sum(players.get_sansin) FROM players WHERE players.team_id = Teams.id)'])
